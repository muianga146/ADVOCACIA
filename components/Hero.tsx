    ...
    return (
        <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
                <span className="inline-block py-1 px-3 rounded-full bg-white/10 border border-white/20 text-white text-xs font-semibold tracking-widest uppercase mb-6 backdrop-blur-sm animate-fade-in">
                    Fundado em 1985
                </span>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <button className="magnetic-btn bg-white text-slate-900 hover:bg-slate-100 px-8 py-4 rounded-lg text-base font-semibold transition-colors shadow-xl">
                        Agendar Consulta
                    </button>
                    <button className="group flex items-center gap-2 px-8 py-4 text-white hover:text-blue-200 transition-colors">
